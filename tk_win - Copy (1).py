...
#---------------------------------------------------------------------------------------------------------------------------------------------------------
    def login(self):
            ...
            def check():
                ...
                if username1=='' or passingword=='' or username1=='Username' or passingword=='Password':
                    ...
                    if row==None:
                        ...
                        cursor.close()
                        con.close()
                        messagebox.showinfo('Login','Welcome to our library ')
            ...
            def on_leave(key):
                name = username.get()
                if name == '':
                    username.insert(0, 'Student name')
           ...
           # on_leave function
            ...
            # Home Button
            Button(root1, text="<BACK>",width=10, pady=6, fg='black',bg='orange', border=0,command=self.Entry_page1).place(x=15, y=25)
            # Librarian login
...
#---------------------------------------------------------------------------------------------------------------------------------------------------------
    def  librarian_login_page(self):
        ...
        def checking():
            ...
            if username1=='' or passingword=='' or username1=='Username' or passingword=='Password':
                messagebox.showerror("Invalid","All feilds are required")
            elif username1=='Admin' and passingword=='Admin':
                global la
                la=True
                messagebox.showinfo('Login','Welcome to our library')
            else:
        ...
        def on_leave(key):
            name = username.get()
            if name == '':
                username.insert(0, 'Librarian name')
        ...
        # Home Button
        Button(root3, text="<BACK>",width=10, pady=6, fg='black',bg='orange', border=0,command=self.Entry_page6).place(x=15, y=25)
        # Student login
...
#---------------------------------------------------------------------------------------------------------------------------------------------------------  
    def register(self):
        ...
        # Home Button
        Button(screen1, text="<BACK>",width=10, pady=6, fg='black',bg='orange', border=0,command=self.Entry_page5).place(x=15, y=25)
        screen1.mainloop()
#---------------------------------------------------------------------------------------------------------------------------------------------------------    
    def add_book(self):
        global screen4
        ...
        Button(screen4, text="<BACK>",width=10, pady=6, fg='black',bg='orange', border=0,command=self.Entry_page7).place(x=15, y=25)
        screen4.mainloop()
#---------------------------------------------------------------------------------------------------------------------------------------------------------
    def select_book(self):
        ...
        Button(screen2, text="<BACK>",width=10, pady=6, fg='black',bg='orange', border=0,command=self.Entry_page2).place(x=15, y=25)
        screen2.mainloop()  
#---------------------------------------------------------------------------------------------------------------------------------------------------------
    def return_book(self):
        ...
        Button(screen3, text="<BACK>",width=10, pady=6, fg='black',bg='orange', border=0,command=self.Entry_page3).place(x=15, y=25)
        screen3.mainloop()         
#---------------------------------------------------------------------------------------------------------------------------------------------------------        
...
#---------------------------------------------------------------------------------------------------------------------------------------------------------
    def ret(self):
        ...
        if dif>2:
            k=(dif-2)*20
        if dif<=2:
            messagebox.showinfo("Fine","Thank you for returning within time/ Thank you for donate the book ")
        else:
